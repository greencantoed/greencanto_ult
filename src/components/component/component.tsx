...
* @see https://v0.dev/t/o6B8sd8hbI7
      ...
      <div className="hidden w-1/2 lg:block">
        <div className="h-full w-full overflow-hidden">
          <div className="h-[6480px] w-full animate-[carousel_30s_linear_infinite]">
            <div className="h-[960px] w-full bg-[url('/carousel-1.jpg')] bg-cover bg-center" />
            <div className="h-[960px] w-full bg-[url('/carousel-2.jpg')] bg-cover bg-center" />
            <div className="h-[960px] w-full bg-[url('/carousel-3.jpg')] bg-cover bg-center" />
            <div className="h-[960px] w-full bg-[url('/carousel-4.jpg')] bg-cover bg-center" />
            <div className="h-[960px] w-full bg-[url('/carousel-5.jpg')] bg-cover bg-center" />
            <div className="h-[960px] w-full bg-[url('/carousel-6.jpg')] bg-cover bg-center" />
          </div>
        </div>
      </div>
